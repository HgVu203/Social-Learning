...
const CreatePostPage = () => {
  ...
  const { loading: isSubmitting } = useSelector(state => state.post);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success && result.data && result.data._id) {
        ...
        setErrors({
          submit: result.error || "Failed to create post: Invalid response from server"
        });
      }
    } catch (error) {
      ...
      if (errorMessage.includes('Network connection error')) {
        ...
        errorMessage = 'Your session has expired. Please login again to create a post.';
      ...
      <div className="prose max-w-none">
        ...
        <div className="flex flex-wrap gap-2 my-4">
          {formData.tags.map(tag => (
            <span key={tag} className="px-2 py-1 text-sm bg-blue-100 text-blue-800 rounded-md">
              #{tag}
            </span>
          ))}
        </div>
        <div className="mt-6 prose-sm sm:prose lg:prose-lg">
      ...
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="mb-6 flex justify-between items-center">
          ...
          <button
            ...
            className="flex items-center text-sm px-3 py-1.5 bg-gray-100 rounded-md text-gray-700 hover:bg-gray-200 transition-colors"
          >
        ...
        {activeTab === 'write' ? (
            ...
            <div className="bg-white shadow-sm rounded-lg overflow-hidden">
              ...
              <div className="p-6 border-b border-gray-100">
                ...
                <div className="flex flex-wrap gap-2 mb-2">
                  {formData.tags.map(tag => (
                    <div key={tag} className="flex items-center bg-blue-50 text-blue-700 rounded-full px-3 py-1 text-sm">
                      #{tag}
                      <button
                        type="button"
          ...
          <div className="mb-6">
            <div className="mb-4 text-sm text-gray-500">
              This is a preview of how your post will look
            </div>
            {renderPreview()}
