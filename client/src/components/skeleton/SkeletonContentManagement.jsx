    ...
    <div className="animate-pulse p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        {[1, 2, 3, 4, 5, 6].map((item) => (
          ...
          >
            {/* Media placeholder */}
            <div className="h-48 bg-[var(--color-bg-light)] w-full"></div>

            <div className="p-4">
              {/* Title and metadata */}
              <div className="flex justify-between items-center mb-3">
                <div className="h-5 bg-[var(--color-bg-light)] rounded w-3/4"></div>
                <div className="h-8 w-8 bg-[var(--color-bg-light)] rounded-full"></div>
              </div>

              <div className="h-4 bg-[var(--color-bg-light)] rounded w-1/2 mb-3"></div>
              ...
              <div className="flex justify-end space-x-2">
                ...
                <div className="h-9 bg-[var(--color-bg-light)] rounded w-9"></div>
                <div className="h-9 bg-[var(--color-bg-light)] rounded w-20"></div>
              </div>
            </div>
          </div>
        ))}
...
export default SkeletonContentManagement;
