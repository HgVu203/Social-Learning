...
const NotFoundPage = () => {
  return (
    <div className="min-h-screen bg-[#16181c] flex flex-col items-center justify-center px-4">
      <div className="text-center">
        <h1 className="text-9xl font-bold text-blue-500">404</h1>
        <h2 className="text-3xl font-semibold text-white mt-6">Trang không tồn tại</h2>
